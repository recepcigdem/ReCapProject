...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void AddUser()
        {
            ...
            userManager.Add(new User() {FirstName = "Recep", LastName = "Çiğdem", Email = "aa@hotmail.com"});
            userManager.Add(new User() {FirstName = "Yavuz", LastName = "Çiğdem", Email = "ba@hotmail.com"});
        }
